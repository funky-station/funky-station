...
ghost-role-information-Bombroach-name = Syndicate Bombroach
ghost-role-information-Bombroach-description = You're the faithful trained pet of nuclear operatives with a microbomb. Serve your master to the death!
ghost-role-information-Bombroach-rules = You are a [color=red][bold]Team Antagonist[/bold][/color] with the agent who summoned you.
