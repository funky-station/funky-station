...
public partial class SharedBodySystem
{
        ...
        bool remove = false)
    {
        ...
        if (!remove)
        {
            ...
            _humanoid.SetLayerVisibility(uid, targetLayer, true, true);
        ...
        BodyPartAppearanceComponent component)
    {
        ...
        if (component.EyeColor != null)
        {
            ...
            _humanoid.SetLayerVisibility(target, HumanoidVisualLayers.Eyes, true, true);
        }

        if (component.Color != null)
            _humanoid.SetBaseLayerColor(target, component.Type, component.Color, true, bodyAppearance);

        _humanoid.SetLayerVisibility(target, component.Type, true, true);

        foreach (var (visualLayer, markingList) in component.Markings)
        {
            _humanoid.SetLayerVisibility(target, visualLayer, true, true);
    ...
    protected void RemoveAppearance(EntityUid entity, BodyPartAppearanceComponent component, EntityUid partEntity)
    {
        ...
        foreach (var (visualLayer, markingList) in component.Markings)
        {
            _humanoid.SetLayerVisibility(entity, visualLayer, false, true);
        }
