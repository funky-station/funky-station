...
public sealed partial class CentCommRoleComponent : Component
{
    ...
    /// <summary>
    ///     The probability that this centcomm role will be available after init.
    ...
    /// <summary>
    /// Reregisters the centcomm role when the current player ghosts.
    /// </summary>
    [ViewVariables(VVAccess.ReadWrite)]
    ...
    /// <summary>
    /// If set, centcomm role is raffled, otherwise it is first-come-first-serve.
    /// </summary>
    [DataField("raffle")]
    [Access(typeof(GhostRoleSystem), Other = AccessPermissions.ReadWriteExecute)] // FIXME Friends
