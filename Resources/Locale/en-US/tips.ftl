...
tips-dataset-69 = As an Engineer, you can use a holofan projector to block gases while allowing objects to pass through. With it, you can quickly contain gas spills, fires and hull breaches.
tips-dataset-70 = As an Engineer, try to resist the temptation of making canister bombs for Nuclear Operatives. They often lead to large amounts of unnecessary collateral damage!
...
tips-dataset-173 = As an Engineer, you can use freezers to cool oxygen or nitrogen to store more mols of gas in the same amount of pressure. This allows you to lower the pressure output on your tank, which lets you breathe from it longer.
