...
public sealed class FoldableSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FoldableComponent, SharedEntityStorageSystem.StoreMobInItemContainerAttemptEvent>(OnStoreThisAttempt);
    ...
    public void OnStoreThisAttempt(EntityUid uid, FoldableComponent comp, ref SharedEntityStorageSystem.StoreMobInItemContainerAttemptEvent args)
    {
        args.Handled = true;
