...
namespace Content.Shared.Atmos
{
    ...
    public static class Atmospherics
    {
        ...
        /// </summary>
        public const int TotalNumberOfGases = 12; //funkystation
    ...
    public enum Gas : sbyte
    {
        ...
        Frezon = 8,
        BZ = 9, //funkystation
        Healium = 10, //funkystation
        Nitrium = 11, //funkystation
    }
}
