...
tips-dataset-140 = All similar electronic items have their wires ordered identically. Finding out which wire is a power wire will remain true across all electronics of that type - or, if the electronic is a door, that department.
...
tips-dataset-171 = To avoid being detected as having opened a door with a logprobe, you can cut the log wire on the door before opening it.
