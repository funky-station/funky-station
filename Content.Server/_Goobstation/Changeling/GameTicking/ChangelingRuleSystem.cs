...
public sealed class ChangelingRuleSystem : GameRuleSystem<Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent>
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent, AfterAntagEntitySelectedEvent>(OnSelectAntag);
        SubscribeLocalEvent<Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent, ObjectivesTextPrependEvent>(OnTextPrepend);
    }

    private void OnSelectAntag(EntityUid uid, Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent comp, ref AfterAntagEntitySelectedEvent args)
    {
        MakeChangeling(args.EntityUid, comp);
    }
    public bool MakeChangeling(EntityUid target, Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent rule)
    {
    ...
    private void OnTextPrepend(EntityUid uid, Content.Server._Goobstation.Changeling.GameTicking.ChangelingRuleComponent comp, ref ObjectivesTextPrependEvent args)
    {
