...
public sealed partial class SmartFridgeItem : BoxContainer
{
    ...
    public SmartFridgeItem(EntProtoId entProto, string name, string quantity, bool addDispenseButtons)
    {
        ...
        var dispenseButtonConstructors = CreateDispenseButtons(entProto, addDispenseButtons);
    ...
    private DispenseButton MakeDispenseButton(string text, FridgeAmount amount, EntProtoId id, string styleClass)
    {
        var button = new DispenseButton(text, amount, id, styleClass);
    ...
    /// </summary>
    private List<DispenseButton> CreateDispenseButtons(EntProtoId id, bool addDispenseButtons)
    {
        ...
        {
            var dispenseButton = MakeDispenseButton(text, amount, id, styleClass);
    ...
    public sealed class DispenseButton : Button
    {
        ...
        public EntProtoId Id { get; set; }
        public DispenseButton(string text, FridgeAmount amount, EntProtoId id, string styleClass)
        {
