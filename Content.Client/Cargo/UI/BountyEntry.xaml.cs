...
public sealed partial class BountyEntry : BoxContainer
{
    ...
    public BountyEntry(CargoBountyData bounty, TimeSpan untilNextSkip)
    {
        ...
        RewardLabel.SetMarkup(Loc.GetString("bounty-console-reward-label", ("reward", bounty.Reward)));
        DescriptionLabel.SetMarkup(Loc.GetString("bounty-console-description-label", ("description", Loc.GetString(bounty.Description))));
