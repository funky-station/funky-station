...
public sealed partial class TurbineWindow : FancyWindow
{
    ...
    {
        TurbineOverspeed.Text = msg.Overspeed.ToString();
        TurbineOvertemp.Text = msg.Overtemp.ToString();
        TurbineStalling.Text = msg.Stalling.ToString();
        TurbineUndertemp.Text = msg.Undertemp.ToString();
    ...
    #region Inputs
    public void SetFlowRate(float rate) => TurbineFlowRateSlider.Value = rate;

    public void SetStatorLoad(float rate) => TurbineStatorLoadSlider.Value = rate;
    #endregion
}