...
/// <summary>
/// An entity with this will pay out a given bank account regularly depending on the amount of power received.
...
public sealed partial class PowerTransmissionComponent : Component
{
    ...
    ///<summary>
    /// The period between depositing money into a bank account.
    ...
    /// Should not be changed during runtime, will cause errors in deposit amounts.
    ///</summary>
    ...
    ///</summary>
    [DataField]
    public float LinearRate = 0.000015f;
    ...
    ///</summary>
    [DataField]
    public float LogarithmCoefficient = 15f;
