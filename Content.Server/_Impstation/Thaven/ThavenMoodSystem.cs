...
public sealed partial class ThavenMoodsSystem : SharedThavenMoodSystem
{
    ...
    private bool TryPick(string datasetProto, [NotNullWhen(true)] out ThavenMoodPrototype? proto,
        ...
        HashSet<ProtoId<ThavenMoodPrototype>>? conflicts = null,
    ...
    protected override void OnEmagged(Entity<ThavenMoodsComponent> ent, ref GotEmaggedEvent args)
    {
        ...
        if (!HasComp<MindShieldComponent>(ent)) // funky: dont emag mindshielded thavens
            TryAddRandomMood(ent, WildcardDataset);
    }
    ...
    private void OnSpawnComplete(PlayerSpawnCompleteEvent args)
    {
        ...
        if (!TryComp<ThavenMoodsComponent>(args.Mob, out var comp))
            return;
