...
public abstract partial class SharedSalvageSystem
{
    ...
    private readonly Dictionary<ISalvageMagnetOffering, float> _offeringWeightsMining = new()
    {
        { new AsteroidOffering(), 3.5f },
    };
    ...
    public ISalvageMagnetOffering GetMiningOffering(int seed)
    {
        var rand = new System.Random(seed);

        var type = SharedRandomExtensions.Pick(_offeringWeightsMining, rand);
        switch (type)
        {
