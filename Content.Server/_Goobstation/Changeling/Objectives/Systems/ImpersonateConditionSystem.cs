...
public sealed class ImpersonateConditionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Components.ImpersonateConditionComponent, ObjectiveAfterAssignEvent>(OnAfterAssign);
        SubscribeLocalEvent<Components.ImpersonateConditionComponent, ObjectiveGetProgressEvent>(OnGetProgress);
    }
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<Components.ImpersonateConditionComponent>();
    ...
    private void OnAfterAssign(EntityUid uid, Components.ImpersonateConditionComponent comp, ref ObjectiveAfterAssignEvent args)
    {
    ...
    private void OnGetProgress(EntityUid uid, Components.ImpersonateConditionComponent comp, ref ObjectiveGetProgressEvent args)
    {
        args.Progress = GetProgress(args.Mind, comp);
    }

    public float GetProgress(MindComponent mind, Components.ImpersonateConditionComponent comp)
    {
