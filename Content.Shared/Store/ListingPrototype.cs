...
{
    public ListingData(Dictionary<ProtoId<CurrencyPrototype>, FixedPoint2> cost)
    {
        Cost = cost;
    }

    public ListingData(ListingData other, Dictionary<ProtoId<CurrencyPrototype>, FixedPoint2> cost) : this(
        other.Name,
