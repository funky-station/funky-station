...
namespace Content.Client.UserInterface.Systems.Ghost.Controls.Roles.CentCommRoles
{
    [UsedImplicitly]
    public sealed class CentCommRolesEui : BaseEui
    {
        private readonly GhostRolesWindow _window;
        private GhostRoleRulesWindow? _windowRules = null;
        private uint _windowRulesId = 0;

        public CentCommRolesEui()
        {
        ...
        public override void HandleState(EuiStateBase state)
        {
            ...
            // Grouping roles
            var groupedRoles = ghostState.GhostRoles.GroupBy(role => (role.Name, role.Description, role.Requirements));
